...
final class TaskControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'task[title]' => 'Testing',
            'task[employees]' => 'Testing',
            'task[description]' => 'Testing',
            'task[Finished]' => 'Testing',
            'task[Time]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setEmployees('Value');
        $fixture->setDescription('Value');
        $fixture->setFinished('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'task[employees]' => 'Something New',
            'task[description]' => 'Something New',
            'task[Finished]' => 'Something New',
            'task[Time]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getEmployees());
